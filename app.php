...
<style>
.flag {
   /* background-image: url('https://cdn.countryflags.com/thumbs/switzerland/flag-round-250.png');*/
    width: 45px;
    height: 45px;
    margin-top: -3px;
    margin-left: -3px;
...
/* <img src="https://cdn.countryflags.com/thumbs/switzerland/flag-round-250.png" width="47px" height="47px" style="margin-top: -18px; margin-left: -4px;"/> */
}
</style>
    </head>
    <body>
